...
Taken from the official Infinity-Parser2 repository.
"""
...
# doc2json prompt — extracts layout to structured JSON with normalised bboxes
PROMPT_DOC2JSON = """
...
# doc2md prompt — directly outputs Markdown
PROMPT_DOC2MD = """
